...
export const LowerBarDiv = styled.div`
  ...
  height: ${(props) => props.theme.height * 0.095}px;
  border: 0px;
  z-index: 99;
`;
...
export const LowerBarCenterButton = styled.button`
  ...
  left: ${(props) =>
    props.theme.width * 0.5 - props.theme.height * 0.075 / 2}px;
...
export const LowerBarCenterButtonImg = styled.img`
  ...
  top: 0;
  left: 0;
  width: ${(props) => props.theme.height * 0.075 - 12}px;
  height: ${(props) => props.theme.height * 0.075 - 12}px;
  border-radius: ${(props) => props.theme.height * 0.075 / 2}px;
...
export const LowerBarButton = styled.div`
  ...
  top: ${(props) =>
    props.theme.height * 0.075 / 2 - props.theme.height * 0.06 / 2}px;
